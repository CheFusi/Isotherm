...
XPS_OC_old<-c(AK_XPS_O_C_1,AL_XPS_O_C_1,AM_XPS_O_C_1,AN_XPS_O_C_1,AO_XPS_O_C_1)
ALL_Biochars$XPS_OC_old<-XPS_OC_old

int_ALL$XPS_OC_old<-c(AM_XPS_O_C,AN_XPS_O_C,AK_XPS_O_C,AO_XPS_O_C,AO_XPS_O_C[1]) #only the first entry of AL since we only have AL00 samples for the int. iso data
...
XPS_OC_may24 <- read_excel("XPS_OC.xlsx")

# Merge the expanded XPS_OC_may24 with ALL_Biochars
ALL_Biochars <- ALL_Biochars %>%
  left_join(XPS_OC_may24, by = "Type_ox")
