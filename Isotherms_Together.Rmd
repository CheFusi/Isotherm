...
new_column_names<-c("group","OX","ID",
                    ...
                    "Q_NH4_avg_sd", "Q_Na_avg_sd","Q_K_avg_sd","Q_Mg_avg_sd", "Q_Cl_avg_sd", "Q_PO4_avg_sd", "Q_SO4_avg_sd",
                    "Q_Ace_avg_sd","Q_NH4_avg_sd_perc","Q_Na_avg_sd_perc","Q_K_avg_sd_perc", "Q_Mg_sd_perc",
...
ALL_Biochars_subset<-ALL_Biochars%>%
  filter(Q_NH4_avg+Q_NH4_avg_sd<6)
...
Norm_sd<-
  ALL_Biochars%>%
  select(c("OC","Q_NH4_avg_sd", "Q_Na_avg_sd", "Q_K_avg_sd","Q_Cl_avg_sd", "Q_PO4_avg_sd", "Q_SO4_avg_sd", "Q_Ace_avg_sd","Dose"))

#Attempting to Represent Uncertainty with Transleucency 

Norm_sd$normalized_NH4_sd <-1-( Norm_sd$Q_NH4_avg_sd / max(Norm_sd$Q_NH4_avg_sd))
Norm_sd$normalized_Na_sd <- 1-( Norm_sd$Q_Na_avg_sd / max(Norm_sd$Q_Na_avg_sd))
Norm_sd$normalized_K_sd <- 1-(Norm_sd$Q_K_avg_sd / max(Norm_sd$Q_K_avg_sd))

Norm_sd$normalized_Cl_sd <-1-( Norm_sd$Q_Cl_avg_sd / max(Norm_sd$Q_Cl_avg_sd))
Norm_sd$normalized_PO4_sd <- 1-( Norm_sd$Q_PO4_avg_sd / max(Norm_sd$Q_PO4_avg_sd))
Norm_sd$normalized_SO4_sd <- 1-(Norm_sd$Q_SO4_avg_sd / max(Norm_sd$Q_SO4_avg_sd))
Norm_sd$normalized_Ace_sd <- 1-(Norm_sd$Q_Ace_avg_sd / max(Norm_sd$Q_Ace_avg_sd))
